...
namespace Bundos.WaterSystem
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        void OnTriggerEnter2D(Collider2D other)
        {
            ...
            if (!interactive)
            {
                other.gameObject.SendMessage("OnEnterWater", SendMessageOptions.DontRequireReceiver);
                return;
            }
        ...
        void OnTriggerExit2D(Collider2D other)
        {
            if (!interactive)
            {
                other.gameObject.SendMessage("OnExitWater", SendMessageOptions.DontRequireReceiver);
                return;
            }
